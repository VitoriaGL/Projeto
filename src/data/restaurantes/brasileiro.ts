import { ProdutoType } from '../Types';
    ...
    export const brasileiro: ProdutoType[] = [
        {
        id: 1,
        nome: "Ravioli al Tartufo Nero",
        descricao: "O Ravioli al Tartufo Nero é um requintado prato de massa artesanal...",
        preco: 69.9,
    ...
    },
    {
        ...
        descricao: "O Spaghetti alla Carbonara é um clássico prato italiano...",
        preco: 56.9,
    ...
    },
    {
        ...
        descricao: "O Risotto ai Funghi Porcini é uma iguaria italiana...",
        preco: 74.9,
    ...
    },
    {
        ...
        descricao: "O Ossobuco alla Milanese é um tradicional prato italiano...",
        preco: 89.9,
    ...
    },
    {
        ...
        descricao: "Melanzane alla Parmigiana é um delicioso prato à base de berinjelas...",
        preco: 62.9,
    ...
    },
    {
        ...
        descricao: "O Frutti di Mare Linguine é uma verdadeira celebração dos sabores do mar...",
        preco: 84.9,
    ...
    },
    {
        ...
        descricao: "A Insalata Caprese é uma salada italiana com tomates e mozzarella di bufala...",
        preco: 49.9,
